...
namespace FeatureRequestPortal.Migrations
{
    ...
    [Migration("20260104234108_UpdateFeatureRequestConstraints")]
    partial class UpdateFeatureRequestConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryFeatureRequest", b =>
                {
                    ...
                    b.HasKey("CategoriesId", "FeatureRequestId");

                    b.HasIndex("FeatureRequestId");

                    b.ToTable("AppFeatureRequestCategories", (string)null);
                });

            modelBuilder.Entity("FeatureRequestPortal.FeatureRequests.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FeatureRequestPortal.FeatureRequests.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FeatureRequestPortal.FeatureRequests.FeatureRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppFeatureRequests", (string)null);
                });

            modelBuilder.Entity("FeatureRequestPortal.FeatureRequests.Vote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppVotes", (string)null);
                });
            ...
            modelBuilder.Entity("CategoryFeatureRequest", b =>
                {
                    b.HasOne("FeatureRequestPortal.FeatureRequests.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FeatureRequestPortal.FeatureRequests.FeatureRequest", null)
                        .WithMany()
